          ...
          <tr>
            <td style="background-color:#FAFAF7; padding:28px 40px;">
              ...
              <p style="margin:0; font-size:12px; line-height:1.6; color:#6B7280;">
                Questions? <a href="mailto:connect@wefundco.com" style="color:#1F2A44; text-decoration:underline;">connect@wefundco.com</a> &nbsp;·&nbsp; © 2026 CapitalPrime Technologies Private Limited. All rights reserved.
              </p>
            </td>
          </tr>
