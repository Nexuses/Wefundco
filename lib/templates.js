        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px; width:100%; background-color:#FFFFFF; border-radius:8px; overflow:hidden;">
          ...
          <tr>
            <td style="padding:0 40px 40px 40px; border-top:1px solid #EAEAEA;">
              ...
              <p style="margin:16px 0 0 0; font-size:14px; line-height:1.6; color:#333333;">
                The WeFundCo Team
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="background-color:#FAFAF7; padding:28px 40px;">
              ...
              <p style="margin:0; font-size:12px; line-height:1.6; color:#6B7280;">
                Questions? <a href="mailto:investments@wefundco.com" style="color:#1F2A44; text-decoration:underline;">investments@wefundco.com</a> &nbsp;·&nbsp; © 2026 CapitalPrime Technologies Private Limited. All rights reserved.
              </p>
            </td>
          </tr>
